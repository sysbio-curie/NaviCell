...
<title>MPhase &#x2014; M-Phase map from CellDesigner samples set</title>
...
<script type='text/javascript'>
  window.document.navicell_module_name = "MPhase:RUM1";
  var overlay;
  var jtree;
  var map;
  var projection;
  ...
  $(document).ready(function() {
    ...
    load_info("../_common/RUM1_info.json", window.document.navicell_module_name);
    load_voronoi("../_common/RUM1_voronoi.csv", window.document.navicell_module_name);
    clickmap_start("MPhase", window.document.navicell_module_name, '#entity_tree', 'map', null, 3, 3, 256, 256, 123, 111, 66, 72, "Rum1", false);
...
M-Phase map from CellDesigner samples set
</div>
<div class='header-right'>
 <a href='javascript_required.html' onclick='try { show_blog(29); } catch (e) {}; return false;' title="go to blog"><img border='0' width='16' height='16' src="../../../map_icons/misc/blog.png" alt='blog'></a>
