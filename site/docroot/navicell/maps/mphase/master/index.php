...
<script type='text/javascript'>
  window.document.navicell_module_name = "MPhase:master";
  var overlay;
  var jtree;
  var map;
  var projection;
  ...
  $(document).ready(function() {
    ...
    clickmap_start("MPhase", window.document.navicell_module_name, '#entity_tree', 'map', null, 1, 3, 256, 256, 123, 111, 66, 72, "APC", true);
...
<div class='header-right'>
 <a href='javascript_required.html' onclick='try { show_blog(28); } catch (e) {}; return false;' title="go to blog"><img border='0' width='16' height='16' src="../../../map_icons/misc/blog.png" alt='blog'></a>
