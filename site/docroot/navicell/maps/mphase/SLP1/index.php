...
<script type='text/javascript'>
  window.document.navicell_module_name = "MPhase:SLP1";
  var overlay;
  var jtree;
  var map;
  var projection;
  ...
  $(document).ready(function() {
    ...
    load_info("../_common/SLP1_info.json", window.document.navicell_module_name);
    load_voronoi("../_common/SLP1_voronoi.csv", window.document.navicell_module_name);
    clickmap_start("MPhase", window.document.navicell_module_name, '#entity_tree', 'map', null, 3, 3, 256, 256, 123, 111, 66, 72, "APC", false);
...
<div class='header-right'>
 <a href='javascript_required.html' onclick='try { show_blog(32); } catch (e) {}; return false;' title="go to blog"><img border='0' width='16' height='16' src="../../../map_icons/misc/blog.png" alt='blog'></a>
