...
<title>MPhase &#x2014; CDC25 Module map</title>
...
<script type='text/javascript'>
  window.document.navicell_module_name = "MPhase:CDC25";
  var overlay;
  var jtree;
  var map;
  var projection;
  ...
  $(document).ready(function() {
    ...
    load_info("../_common/CDC25_info.json", window.document.navicell_module_name);
    load_voronoi("../_common/CDC25_voronoi.csv", window.document.navicell_module_name);
    clickmap_start("MPhase", window.document.navicell_module_name, '#entity_tree', 'map', null, 2, 2, 256, 256, 108, 149, 74, 53, "APC", false);
...
<div class='header-right'>
 <a href='javascript_required.html' onclick='try { show_blog(31); } catch (e) {}; return false;' title="go to blog"><img border='0' width='16' height='16' src="../../../map_icons/misc/blog.png" alt='blog'></a>
